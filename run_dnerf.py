...
def create_nerf(args):
    ...
    if args.ft_path is not None and args.ft_path!='None':
        ckpts = ModelCheckpoint(args.ft_path)
    else:
        ckpts = ModelCheckpoint(os.path.join(basedir, expname, f) for f in sorted(os.listdir(os.path.join(basedir, expname))) if 'tar' in f)
    ...
    return render_kwargs_train, render_kwargs_test, grad_vars
...
class train(LightningModule):
    ...
    def __init__(self):
        ...
        self.model = create_nerf(self.args)
